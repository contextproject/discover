...
public class CommentRetrieverTest {
  ...
  public void testGetComments() throws Exception {
    ...
    databaseConnector
        .executeUpdate("INSERT INTO comments_without_features VALUES"
            + "(1, 1, 1, '2015-01-01 12:00:00', 1, 'test')");
    ...
    databaseConnector
        .executeQuery("DELETE FROM comments_without_features WHERE track_id = 1"
            + "AND comment_id = 1 AND user_id = 1 "
            + "AND created_at = '2015-01-01 12:00:00' AND timestamp = 1 AND text = 'test'");
  }
}