...
public class RandomSongSelectorTest {
    ...
    public static void setUpBeforeClass() throws Exception {
        DatabaseConnector dc = DatabaseConnector.getConnector();
        dc.loadDrivers();
        final String url = "jdbc:mysql://188.166.78.36/contextbase";
        dc.makeConnection(url, "context", "password");
     ...
     * returns two instances that satisfy the equals method. For subclasses this
    ...
    public void testGetSelectorAddressCheck() {
        assertTrue(getRandomSongSelector() == RandomSongSelector
                .getRandomSongSelector());
    }
    ...
    /**
     * Tests the {@link RandomSongSelector#getQuery()} method and checks if it
     * is a select query.
     */
    @Test
    ...
    /**
     * Tests the {@link RandomSongSelector#getQuery()} method on consistency.
     */
    @Test
