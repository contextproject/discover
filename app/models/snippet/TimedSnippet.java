...
public class TimedSnippet {
     ...
     * @param duration  The window of the snippet in ms.
     *                  If the window is 0 or less the default is used.
     */
    ...
    /**
     * Sets the default window of the snippet.
     * If window is less than 0 this method does nothing.
     *
     * @param duration The new default window.
     */
     ...
     * @param durationInSeconds The window of the snippet in seconds.
