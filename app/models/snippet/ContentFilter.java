...
public class ContentFilter {
   ...
   */
  private final String[] positive = { "great", "brilliant", "beautiful", "awesome", "amazing",
      "perfect", "good", "like", "love", "best", "nice", "super", "cool", "massive", "wicked",
      "sick" };

  /**
   * List of negative words.
   */
  private final String[] negative = { "hate", "n't", "nt", "not", "bad", "terrible", "worst",
      "suck" };
  ...
  public double findEmoticons(final String body) {
    if (body.contains(":)") || body.contains("<3") || body.contains(":d") || body.contains(":-)")
        || body.contains("=d")) {
      return 1;
    } else {
      return 0;
