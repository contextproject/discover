...
/**
 * The Class that is responsable for the splitting of the mix in
...
public class MixSplitter {
	...
	/**
	 * Creates a new mixsplitter which can then split the given
	 * mix into different pieces.
	 ...
	 * @return The list of new starttimes, for which every starttime is
	...
	/**
	 * Splits the {@link #data} into different lists that can then be
	 * compared.
	...
	/**
	 * Gets the jaccard distance between the first and the second list
	 * of floats.
	 * @param first The first of the lists of floats to compare.
	 * @param second The second list.
	 * @return The jaccard distance between first and second.
	 */
	public double getJaccardDistance(final List<Float> first, final List<Float> second) {
		return 0.0;
	}
	
	/**
	 * Returns the list of data on which we operate while splitting the
	 * mix into smaller pieces.
	 * @return The list of floats that contain the information on which
	 * to split.
	 */
	...
	/**
	 * Sets the data to be used to the given value. This given value
	 * should be the result of the waveformat of the mix.
